...
def main():
    ...
    #toolbar2 = Frame(mainui, bg="BLUE")
    #toolbar2.grid(row=0, column=1, sticky="nswe")
    ...
    #graph2 = Frame(mainui, bg="yellow")
    #graph2.grid(row=2, column=1, sticky="nswe")

    mainui.rowconfigure(0, weight=1)
    mainui.rowconfigure(1, weight=6)
    mainui.rowconfigure(2, weight=6)
